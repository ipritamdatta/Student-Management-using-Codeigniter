...
class Admin_model extends CI_Model {
    ...
    public function all_student_info_edit($student_id){
        $this->db->SELECT('*');
        $this->db->FROM('student');
        $this->db->WHERE('student_id',$student_id);
        $query_result=$this->db->get();
        $updateresult=$query_result->row();
        return $updateresult;
    }
    ...
    public function update_student_info(){
        ...
        $query = $this->db->get_where('student', array('student_roll ' => $data['student_roll']))->result();
