						...
						<form class="form-horizontal" action="<?php echo base_url()?>update-student" method="post">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="date01" name="student_name" value="<?php echo $all_student_info_edit->student_name;?>">
							  </div>
                              <div class="controls">
								<input type="hidden" class="input-xlarge" id="date01" name="student_id" value="<?php echo $all_student_info_edit->student_id;?>">
							  </div>
							</div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="date01" name="student_phone" value="<?php echo $all_student_info_edit->student_phone;?>">
							  </div>
                            </div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="date01" name="student_roll" value="<?php echo $all_student_info_edit->student_roll;?>">
							  </div>
							</div>
							<!-- <div class="control-group">
