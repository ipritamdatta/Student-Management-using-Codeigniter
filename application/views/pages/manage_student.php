						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  ?>
							<tr>
								...
								<td>
									<a class="btn btn-info" href="<?php echo base_url()?>edit-student/
									<?php echo $v_student->student_id?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="<?php echo base_url()?>delete-student/
									<?php echo $v_student->student_id?>" id="delete">
